...
class CanvasObject extends VariableClass {
    constructor(id, name, onCreate = (_this) => { }, onUpdate = (_this) => { }, onDestroy = (_this) => { }, destroyById, canvasX) {
        ...
        _CanvasObject_onCollisionEnter.set(this, null);
        this.getId = () => {
        ...
        this.getClickRelease = () => {
            return __classPrivateFieldGet(this, _CanvasObject_onClickRelease, "f");
        };
        this.setClickRelease = (func) => {
            __classPrivateFieldSet(this, _CanvasObject_onClickRelease, func, "f");
        };
        this.addOnCollisionEnter = (targetObject_id_or_name, func) => {
            ...
            __classPrivateFieldGet(this, _CanvasObject_onCollisionEnter, "f").push({
                target: targetObject_id_or_name,
                isCollision: false,
                func,
            });
        };
        this.getOnCollisionEnter = () => {
            return __classPrivateFieldGet(this, _CanvasObject_onCollisionEnter, "f");
        };
        this.destroy = () => {
