...
var _CanvasX_width, _CanvasX_height, _CanvasX_ctx, _CanvasX_objectsCreated, _CanvasX_drawCanvas, _CanvasX_logic, _CanvasX_canvasUpdate, _CanvasX_destroyObjectById;
...
_CanvasX_width = new WeakMap(), _CanvasX_height = new WeakMap(), _CanvasX_ctx = new WeakMap(), _CanvasX_objectsCreated = new WeakMap(), _CanvasX_drawCanvas = new WeakMap(), _CanvasX_logic = new WeakMap(), _CanvasX_canvasUpdate = new WeakMap(), _CanvasX_destroyObjectById = new WeakMap();
